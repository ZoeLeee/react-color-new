 ...
 * @returns
 */
export const rbgaObjToHex = (rgba) => {
    let { r, g, b } = rgba;
    const { a } = rgba;
    r = Math.floor(r * a);
    g = Math.floor(g * a);
 ...
 * @returns
 */
export const rbgaObjToRgba = (rgba) => {
    const { r, g, b, a } = rgba;
    return `rgba(${r},${g},${b},${a})`;
};
/**
 ...
 * @returns
 */
export const renderColorInfo = (params) => {
 ...
 * @returns
 */
export function drawPipette(colors, size = 8) {
    const scale = 2;
    const canvasContainer = document.createElement('div');
    const canvasContent = document.createElement('div');
    const pipetteCanvas = drawPipetteCanvas(colors, size);
 ...
 * @returns
 */
export function drawColorBlock(color) {
 ...
 * @returns
 */
export function drawTooltip(content, tooltipVisible = true) {
 ...
 * @returns
 */
export function drawPipetteCanvas(colors, size) {
 ...
 * @returns
 */
export function getCanvas({ width = 0, height = 0, scale = 1, attrs = {} }) {
 ...
 * @returns
 */
const getImageColor = (data, rect, scale = 1) => {
    const colors = [];
 ...
 * @returns
 */
export const getCanvasRectColor = (ctx, rect, scale = 1) => {
